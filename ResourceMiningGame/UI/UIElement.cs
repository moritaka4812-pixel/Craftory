...
namespace ResourceMiningGame.UI
{
    public abstract class UIElement
    {
        ...
        public int Width { get => rect.Width; set => new Rect(rect.X, rect.Y, value, rect.Height);  }
        public int Height { get => rect.Height; set => new Rect(rect.X, rect.Y, rect.Width, value);  }
        //アンカープロパティ
